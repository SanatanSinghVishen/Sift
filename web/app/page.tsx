            ...
            <div className="lg:col-span-5">
              ...
              <div className="flex items-center gap-4 flex-wrap">
                ...
                <a
                  ...
                  title="Email: sanatansinghgonda@gmail.com"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  title="GitHub: SanatanSinghVishen/Sift-1B"
                  className="w-12 h-12 rounded-full border border-[#27272A] bg-[#151515] hover:bg-[#222225] hover:border-white/50 text-[#A1A1AA] hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg group"
                >
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  title="Hugging Face: SanatanSinghVishen"
                  className="w-12 h-12 rounded-full border border-[#27272A] bg-[#151515] hover:bg-[#222225] hover:border-white/50 text-[#A1A1AA] hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg text-lg group"
                >
                  🤗
                </a>
